...
const Blog = () => {
    return (
        <div className='px-1 md:px-2 lg:px-4 my-8'>
            ...
            <div class="card my-4 min-h-fit bg-base-100 shadow-xl shadow-green-500/50">
                <div class="text-center">
                    <div class="w-full card-body">
                        <h1 class="text-xl lg:text-3xl font-bold">1. What are the different ways to manage a state in a React application?</h1>
                        <p class="py-6">Four Kinds of React State to Manage. <br />
                            1. Local state <br />
                            2. Global state <br />
                            3. Server state <br />
                            4. URL state <br />
            ...
            <div class="card my-4 min-h-fit bg-base-100 shadow-xl shadow-green-500/50">
                <div class="text-center">
                    <div class="w-full card-body">
                        <h1 class="text-xl lg:text-3xl font-bold">2. How does prototypical inheritance work?</h1>
                        <p class="py-6">
            ...
            <div class="card my-4 min-h-fit bg-base-100 shadow-xl shadow-green-500/50">
                <div class="text-center">
                    <div class="w-full card-body">
                        <h1 class="text-xl lg:text-3xl font-bold">3. What is a unit test? Why should write unit tests?</h1>
                        <p class="py-6">
            ...
            <div class="card my-4 min-h-fit bg-base-100 shadow-xl shadow-green-500/50">
                <div class="text-center">
                    <div class="w-full card-body">
                        <h1 class="text-xl lg:text-3xl font-bold">4.You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h1>
                        <p class="py-6">
            ...
            <div class="card my-4 min-h-fit bg-base-100 shadow-xl shadow-green-500/50">
                <div class="text-center">
                    <div class="w-full card-body">
                        <h1 class="text-xl lg:text-3xl font-bold">5. Why you do not set the state directly in React ?</h1>
                        <p class="py-6">
