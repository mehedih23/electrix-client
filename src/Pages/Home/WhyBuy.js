            ...
            <div className='grid grid-cols-1 md:grid-cols-12 gap-5 my-4'>
                ...
                <div className='md:col-span-8'>
                    <div className='grid grid-rows-6 md:grid-rows-none md:grid-cols-2 gap-5'>
                        <div className="card bg-base-100 shadow-xl shadow-green-500/40">
                            <div className="p-2 flex">
                                ...
                                <div className='ml-4'>
                                    <h2 className="text-accent text-2xl my-2">Material Research</h2>
                        ...
                        <div className="card bg-base-100 shadow-xl">
                            <div className="p-2 flex">
                                ...
                                <div className='ml-4'>
                                    <h2 className="text-accent text-2xl my-2">Quality Production</h2>
                        ...
                        <div className="card bg-base-100 shadow-xl">
                            <div className="p-2 flex">
                                ...
                                <div className='ml-4'>
                                    <h2 className="text-accent text-2xl my-2">Eco-friendly Materials</h2>
                        ...
                        <div className="card bg-base-100 shadow-xl shadow-green-500/40">
                            <div className="p-2 flex">
                                ...
                                <div className='ml-4'>
                                    <h2 className="text-accent text-2xl my-2">Replacement Guarantee</h2>
                        ...
                        <div className="card bg-base-100 shadow-xl shadow-green-500/40">
                            <div className="p-2 flex">
                                ...
                                <div className='ml-4'>
                                    <h2 className="text-accent text-2xl my-2">Affiliate Programs</h2>
                        ...
                        <div className="card bg-base-100 shadow-xl">
                            <div className="p-2 flex">
                                ...
                                <div className='ml-4'>
                                    <h2 className="text-accent text-2xl my-2">Product Serviceability</h2>
