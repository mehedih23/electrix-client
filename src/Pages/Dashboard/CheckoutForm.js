...
const CheckoutForm = ({ item }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const { error, paymentMethod, customerName } = await stripe.createPaymentMethod({
            type: 'card',
            card,
        });
    ...
    return (
        <div>
            ...
            {success && <>
                ...
                <p className='text-green-600 mt-5'><small>TransactionId : {transactionId}</small></p>
            </>}
        </div>
    )
}
